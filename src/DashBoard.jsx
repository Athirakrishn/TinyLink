...
import { faChartColumn, faChevronDown, faChevronUp, faPlus, faSearch, faTrash } from '@fortawesome/free-solid-svg-icons'
 ...
 <div className="container mx-10 mb-10">
   <p >Destination URL - Paste URL here...</p>
      <div className="flex rounded-xl overflow-hidden w-full max-w-2xl">
        ...
        />
        <button className="bg-indigo-900 text-white px-6 py-3 font-semibold hover:bg-indigo-100 hover:text-black">
          Shorten link
        </button>
      </div>
</div>
    ...
    <tbody>
      <tr className="border-t">
        ...
        <td className="px-4 py-2 flex gap-4">
          <FontAwesomeIcon icon={faChartColumn} onClick={()=>navigate('/code/:code')} className="text-green-500 cursor-pointer hover:text-green-700" />
